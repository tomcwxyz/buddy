...
const cases = [
  ...
  },
  {
    ...
    assertions: {
      ...
      partOfSpeech: "verb",
      sourceOneOf: ["buddy-corpus"],
      pronunciation: "k l ˈəʊ z",
      meaningIncludesAny: ["shut", "open"],
      remoteFallback: false,
    },
  },
  {
    id: "close-near",
    word: "close",
    context: "Stay close to me.",
    assertions: {
      recognised: true,
      partOfSpeech: "adjective",
      sourceOneOf: ["buddy-corpus"],
      pronunciation: "k l ˈəʊ s",
      meaningIncludesAny: ["near", "distance"],
      remoteFallback: false,
    },
  },
  {
    id: "live-verb",
    word: "live",
    context: "We live near the park.",
    assertions: {
      recognised: true,
      partOfSpeech: "verb",
      sourceOneOf: ["buddy-corpus"],
      pronunciation: "l ˈɪ v",
      meaningIncludesAny: ["home", "place"],
      remoteFallback: false,
    },
  },
  {
    id: "live-adjective",
    word: "live",
    context: "The concert is live on television.",
    assertions: {
      recognised: true,
      partOfSpeech: "adjective",
      sourceOneOf: ["buddy-corpus"],
      pronunciation: "l ˈaɪ v",
      meaningIncludesAny: ["happening", "shown", "alive"],
      remoteFallback: false,
    },
  },
  {
    id: "use-verb",
    word: "use",
    context: "We use a pencil to write.",
    assertions: {
      recognised: true,
      partOfSpeech: "verb",
      sourceOneOf: ["buddy-corpus"],
      pronunciation: "j ˈuː z",
      meaningIncludesAny: ["object", "method", "achieve"],
      remoteFallback: false,
    },
  },
  {
    id: "use-noun",
    word: "use",
    context: "This is a good use of the space.",
    assertions: {
      recognised: true,
      partOfSpeech: "noun",
      sourceOneOf: ["buddy-corpus"],
      pronunciation: "j ˈuː s",
      meaningIncludesAny: ["purpose", "way"],
      remoteFallback: false,
    },
  },
  {
