...
- `/practice/coaster` — the build-and-ride word world for the active practice set: direct visual track selection per explored word, separate Build and Ride modes, cumulative lift/drop terrain, loops/corkscrews/tunnels, station launch speed, boosts/brakes, descriptive ride character, draggable cart and a momentum-based animated ride.
