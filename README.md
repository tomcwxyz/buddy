...
- `/` — action-first home.
- `/read` — live camera capture, local OCR, selectable words, spoken help and child-controlled scaffolding. Browser-native voice choice and pace are shared with Play and remembered on the device.
...
- `/discover` — **Explore**: playable little worlds for motion, adaptation and patterns, designed around changing, predicting, explaining and trying another way rather than scores.
