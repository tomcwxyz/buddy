...
function corpusMetadata(
  ...
  return {
    ...
    surfaceCuratedMeaningHit: surface.corpus.curatedMeaningHit,
    surfaceWordNetHit: surface.corpus.wordnetEntryHit,
    surfaceWordNetSenseCount: surface.corpus.wordnetSenseCount,
    surfaceWordNetTaggedSenseCount: surface.corpus.wordnetTaggedSenseCount,
    wordnetAvailable: surface.corpus.wordnetAvailable,
    wordnetVersion: surface.corpus.wordnetVersion,
    ...
    lemmaCuratedMeaningHit: lemmaLookup?.corpus.curatedMeaningHit ?? null,
    lemmaWordNetHit: lemmaLookup?.corpus.wordnetEntryHit ?? null,
    lemmaWordNetSenseCount: lemmaLookup?.corpus.wordnetSenseCount ?? null,
